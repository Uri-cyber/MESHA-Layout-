...
export const DocumentViewerScreen: React.FC<Props> = ({ onNavigate }) => {
  return (
    <MobileLayout className="bg-stone-900">
      ...
      <div className="flex-1 bg-white/10 backdrop-blur-sm m-4 rounded-3xl flex items-center justify-center border border-white/10">
        <p className="text-white/50 font-medium">PDF Preview Placeholder</p>
      </div>

      <div className="px-6 pb-8 pt-2 flex justify-around">
        <button className="flex flex-col items-center gap-2 text-white/70 hover:text-white">
